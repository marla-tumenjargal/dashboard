    ...
    return (
        <div className="hero-container">
            ...
            <div className="hero-content-wrapper">
                ...
                <div className="hero-folders-grid">
                    <div className="folder-item">
                        <img src="/projectsfolder.jpg" alt="projects folder" className="folder-image original-image" />
                        <img src="/activeprojectsfolder.jpg" alt="active projects folder" className="folder-image active-image" />
                    </div>
                    <div className="folder-item">
                        <img src="/uifolder.jpg" alt="UI folder" className="folder-image original-image" />
                        <img src="/activeuifolder.jpg" alt="active UI folder" className="folder-image active-image" />
                    </div>
                    <div className="folder-item">
                        <img src="/writingfolder.jpg" alt="writing folder" className="folder-image original-image" />
                        <img src="/activewritingfolder.jpg" alt="active writing folder" className="folder-image active-image" />
                    </div>
                    <div className="folder-item">
                        <img src="/projectsfolder.jpg" alt="projects folder" className="folder-image original-image" />
                        <img src="/activeprojectsfolder.jpg" alt="active projects folder" className="folder-image active-image" />
