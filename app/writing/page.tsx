...
export default function WritingPage() {
  ...
  const articles: Article[] = [
    ...
    this fall semester, i'm taking Data 94, which explores the social dynamics behind computational thinking, including topics such as AGI, 
    recommendation systems, the Turing test as a marker of intelligence, and free speech online. behind the fundamental questions of
    technology's role in society is binary. binary is credited to Leibniz. similarly to Mendel, he combined two different fields 
    (logic and algebra) together to create a "language" of sorts--that is the precursor to probabilistic inference.     
    he proved that everything done by our mind is possible with computation. he believed math was a language. private language can not exist.
    you can not express a concept if it does not have a name (again, why we don't have memories as babies because we can not conceptualize 
    what we do not yet know) and math is a language and language is simply made up of symbols/signs thus, we can not think or reason or 
    ...
    you would not intuitively correlate that with "pumping blood." most empirical knowledge drives scientific knowledge since we always
     discovering new facts that continue creating new knowledge. we do not think through these three laws of thought but we experience and 
     behave through them. 
      
    leibniz also thought that there must be a metaphysical grounding to everything. binary is either on or off. 
    it has a certain specialness to it because that is how humans think. we can not know what is good but we do understand 
